...
require 'kimurai' # ~> LoadError: cannot load such file -- kimurai
...
# ~> LoadError
# ~> cannot load such file -- kimurai
# ~>
# ~> /Users/iczman/.rbenv/versions/2.6.1/lib/ruby/site_ruby/2.6.0/rubygems/core_ext/kernel_require.rb:54:in `require'
# ~> /Users/iczman/.rbenv/versions/2.6.1/lib/ruby/site_ruby/2.6.0/rubygems/core_ext/kernel_require.rb:54:in `require'
# ~> spider.rb:1:in `<main>'
